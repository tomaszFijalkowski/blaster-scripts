...
void ADamagePickup::OnSphereBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
                                         ...
                                         const FHitResult& SweepResult)
{
	...
	if (const ABlasterCharacter* BlasterCharacter = Cast<ABlasterCharacter>(OtherActor))
	{
		...
		{
			BuffComponent->BuffDamage(DamageMultiplier, BuffDuration);
